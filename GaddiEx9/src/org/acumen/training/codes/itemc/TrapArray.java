...
public class TrapArray {
	...
	private void inputSize(Scanner scanner) {
		...
		while (true) {
			...
			try {
				...
				System.out.println("Invalid element value: [non-integer]");
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	private String checkInput(String inputSize) 
	...
	private void checkElement(String inputElement) 
	...
	private void checkString(String inputElement) 
			throws ElementStringException, Exception {
	...
	private void checkRealNums(String inputElement) 
	...
	private void viewElements(Scanner scanner) {
		...
		while (true) {
			...
			try {
				...
				checkIndex(index);
				System.out.println("The Value in index %d is %d"
									.formatted(index, array[index]));
